...
const Header = () => {
  ...
  useEffect(() => {
    const mdMediaQuery = window.matchMedia(`(min-width: ${breakpoints["md"]}px)`);
    ...
    <header className="bg-[#cd3c2b] shadow-lg border-b border-red-800">
      <div className="container mx-auto py-1 md:flex md:items-center">
        <div className="flex justify-between items-center">
          ...
          <div className="md:hidden" onClick={() => setIsMobileMenuVisible(!isMobileMenuVisible)}><MenuIcon className="h-5 w-5 text-white" /></div>
        </div>
